...
public class WriterCSVHelper {
    ...
    public static void writeOpenCSV(ResultSet rs, BufferedWriter w) throws SQLException, IOException {
    ...
    public static void writeSuperCSV(ResultSet rs, BufferedWriter w) throws SQLException, IOException {
